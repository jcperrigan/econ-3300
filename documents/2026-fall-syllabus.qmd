...
**Days and times:** Mondays, 3:00 p.m. to 5:40 p.m.

**Dates:** August 24 to December 18, 2026

**Location:** Remote, [click here to enter the Zoom classroom](https://unomaha.zoom.us/j/92904049672)
...
It is also expected that you are familiar with probability and statistics. We will go through chapters two and three that review probability and statistics, but if there is anything that you need to review more please make sure to take some time to do so. 
...
- Industry econometrics challenge: 49%

  - Client proposal: 3%

  - Data audit and descriptive analysis: 4%

  - Empirical strategy memo: 5%

  - Preliminary results: 6%

  - Progress conference/ checkpoint: 3%

  - Peer quality-assurance review: 3%

  - Final consulting report: 12%

  - Client presentation: 5%

  - Individual oral defense: 5%

  Individual contribution/ reflection memo: 3%
...
There is one midterm exam and one cumulative final exam, each worth 15% of your final grade. The exam will include R code and output, some of which is useful for answering the questions.
...
### Industry Econometrics Challenge

The objective of this assignment is to apply the econometric methods studied in this course to an industry-related problem. You will work in a team to analyze a business question using data and present your findings as recommendations to a client or decision-maker.

Your team will select from the available client briefs and datasets. You will need to define the client’s question carefully, determine what the available data can and cannot establish, develop an appropriate econometric model, and translate your results into useful conclusions. Your analysis should distinguish between prediction, association, and causal inference and should clearly explain any important limitations.

The final deliverables will include a concise consulting report, a reproducible technical appendix, and a client presentation. The presentation will be followed by an oral defense in which individual team members will be asked to explain the group’s modeling decisions, interpret results, and discuss limitations. Each student will also submit an individual contribution and reflection memo.

The Industry Econometrics Challenge accounts for 49% of your final grade and will be completed in stages throughout the semester. These checkpoints are intended to give your team regular feedback and prevent major problems with the question, data, or empirical strategy from carrying into the final analysis.


**Important Deadlines:**

- September 13: Client Proposal Due

- October 4: Data Audit and Descriptive Analysis Due

- October 18: Empirical Strategy Memo Due

- November 1: Preliminary Results

- November 15: Peer Quality-Assurance Review Due

- November 16–20: Team Progress Conference

- November 8: Peer Reviews Due

- November 29: Final Consulting Report and Technical Appendix due 

- November 30: Client Presentation and Oral Defense

- December 7: Individual Contribution and Reflection Memo Due
...
- Stock and Watson's **Introduction to Econometrics**, ISNB-13 9780136879787. You have access to this book through First Day Access. [To opt out of First-Day Access, and for more information, click here.](https://www.omahamaverickstore.com/first_day_access_faq.asp)
...
- Week 2: Review of Statistics and Probability

- Week 3: No Class, Labor Day

- Week 4: Simple Linear Regression

- Week 5: Simple Linear Regression: Hypothesis Tests and Confidence Intervals

- Week 6: Linear Regression with Multiple Regressors

- Week 7: Nonlinear Regression Functions

- Week 8: Midterm Exam

- Week 9: No Class, Fall Break

- Week 10: Assessing Regression Studies

- Week 11: Binary Dependent Variable Models

- Week 12: Panel Data

- Week 13: Experiments and Quasi-Experiments

- Week 14: Prediction with Many Regressors and Big Data
